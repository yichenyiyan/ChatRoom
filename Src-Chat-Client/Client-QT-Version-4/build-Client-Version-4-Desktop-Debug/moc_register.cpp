...
#include <memory>
#include "../Client-Version-4/register.h"
...
QT_MOC_LITERAL(3, 15, 6), // "toBack"
QT_MOC_LITERAL(4, 22, 25), // "on_registerButton_clicked"
QT_MOC_LITERAL(5, 48, 21) // "on_backButton_clicked"

    },
    "Register\0back\0\0toBack\0on_registerButton_clicked\0"
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::back)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Register::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::toBack)) {
                *result = 1;
                return;
            }
        }
