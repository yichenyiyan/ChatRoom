...
yichen_sign::yichen_sign(QWidget* parent)
    : QDialog(parent) {
...
yichen_sign::~yichen_sign() {
    tcpSocket->disconnectFromHost();
}

void
yichen_sign::slotConnect() {
